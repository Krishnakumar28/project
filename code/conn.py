...
class ATM():
    ...
    def account_detail(self):
        sql="insert into account_holder (account_num,name,password) values (%s,%s,%s)"

        val=(account_num,name,password)


        mycursor.execute(sql,val)
        mydb.commit()
        print("\n----------ACCOUNT DETAIL----------")
        print(f"Account num: {self.account_num}")
...
print("*******WELCOME TO BANK OF TENKASI*******")
...
atm = ATM(name,account_num,password)
